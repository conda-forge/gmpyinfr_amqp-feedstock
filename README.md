About gmpyinfr_amqp-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gmpyinfr_amqp-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12315&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gmpyinfr_amqp-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gmpyinfr_amqp` can be installed with `conda`:
...
```
mamba install gmpyinfr_amqp
```

It is possible to list all of the versions of `gmpyinfr_amqp` available on your platform with `conda`:
...
```
mamba search gmpyinfr_amqp --channel conda-forge
```
...
mamba repoquery search gmpyinfr_amqp --channel conda-forge

# List packages depending on `gmpyinfr_amqp`:
mamba repoquery whoneeds gmpyinfr_amqp --channel conda-forge

# List dependencies of `gmpyinfr_amqp`:
mamba repoquery depends gmpyinfr_amqp --channel conda-forge
```
